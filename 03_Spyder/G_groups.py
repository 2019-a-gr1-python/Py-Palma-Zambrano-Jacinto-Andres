# -*- coding: utf-8 -*-
"""
Created on Sat Jun  8 09:48:20 2019
...
path_guardado = 'C:\\Users\\Dario\\Documents\\Python-R\\Py-Palma-Zambrano-Jacinto-Andres\\03_Spyder\\data\\artwork_data.pickle'
...
df.filter(items= ["artist","title"])

condición = lambda x:len(x.index)>1

df_titulos_dup = df_agrupado_titulo.filter(condicion)

#Ordenar a los titulos dubplicados
df_titulos_dup.sort_values('title')
